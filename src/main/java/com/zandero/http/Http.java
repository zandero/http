...
public final class Http {
    ...
    public static class Response {
         ...
         *
         * @param statusCode      http status code
         * @param requestResponse response body as string
         ...
         * Checks if status is
         *
         * @param status list of status codes
         * @return true if status is listed
         */
        ...
        /**
         * Checks response status is not
         *
         * @param status list of status codes
         * @return true if status is not listed
         */
